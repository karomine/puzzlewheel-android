...
public abstract class GamePiece {
    ...
    private static void rotateRight(GamePiece piece) {
        switch (piece.corner) {
            case TOP_RIGHT:
                piece.corner = BOTTOM_RIGHT;
                break;
            case TOP_LEFT:
                piece.corner = TOP_RIGHT;
                break;
            case BOTTOM_LEFT:
                piece.corner = TOP_LEFT;
                break;
            case BOTTOM_RIGHT:
                piece.corner = BOTTOM_LEFT;
                break;
        }
    }

    private static void rotateLeft(GamePiece piece) {
        switch (piece.corner) {
            case TOP_RIGHT:
                piece.corner = TOP_LEFT;
                break;
