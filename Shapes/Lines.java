...
public class Lines {
    ...
    static public int getSection(int xCoordinate, int yCoordinate, float scale) {
    ...
    static private Boolean fallAbove(int[] lines, int xCoordinate, int yCoordinate, float scale) {
    ...
    static private Boolean fallBelow(int[] lines, int xCoordinate, int yCoordinate, float scale) {
        for (int i = 0; i < lines.length; i++) {
            if (above(xCoordinate, yCoordinate, lines[i], scale)) {
                return false;
            }
    ...
    static private Boolean above(int xCoordinate, int yCoordinate, int index, float scale) {
